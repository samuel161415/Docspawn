...
import DataSource from './data_source-Cv7FEqxx.mjs';
import { useSSRContext } from 'vue';
import './data_sources-DxVhtQSS.mjs';
import './button.esm-DZ8732aK.mjs';
import './badge.esm-B18HZmxV.mjs';
import './entry-DIZlnTgU.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(DataSource, _attrs, null, _parent));
    };
  }
};
...
//# sourceMappingURL=index-DRb_DQw0.mjs.map
